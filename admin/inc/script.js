...
function initialize(){
  ...
  mesjid_dig = new google.maps.Data();
	mesjid_dig.loadGeoJson('act/insert_reparasi.php?id='+id.value);
...
function add(){
  $('#l_form').append('<input type="text" class="form-control" name="produk[]" value="" style="margin-bottom:3px;" required>');
}
function add1(){
  $('#l_form').append('<input type="text" class="form-control" name="merek[]" value="" style="margin-bottom:3px;" required>');
}
function add2(){
