...
include("../connect.php");?>
    ...
    <section class="panel">
        ...
        <form role="form" action="act/insertprod.php" method="post">
          ...
          <div class="form-group" style="clear:both" id="l_form">
            ...
            <input type="text" class="form-control" name="produk[]" value="" style="margin-bottom:3px;" autofocus required>
          </div>
        </form>

        <?php } if (isset($_GET['jenis_elektronik_id'])){
                    $jenis_elektronik_id=$_GET['jenis_elektronik_id'];
                    $sql = pg_query("SELECT jenis_elektronik_id, nama_elektronik FROM produk where jenis_elektronik_id=$jenis_elektronik_id");
