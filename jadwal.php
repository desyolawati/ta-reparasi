     ...
     <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo" color="white"><i class="fa fa-search"></i> Pencarian</a>
                     ...
                     <li>
                        <a href="javascript:;" data-target="#demo"><i class="fa fa-list-ul"></i> Daftar Tempat Reparasi </a>
        ...
        <div id="page-wrapper">
            <label> Berdasarkan Jadwal Operasional </label>
             <div class="panel-body">

                  <div class="input-append input-group" id="datetimepicker3">
                    <input class="form-control" data-format="hh:mm:ss" type="text" name="jamcari" id="jamcari" placeholder="00:00:00" value="<?php echo $now ">
           ...
           <div class="row">
            <div class="col-lg-8"> 
              ...
              <div id="isi-r"></div>           
                 ...
                 <section class="panel">
                    <div class="panel-body" >
                        <center><a class="btn btn-sm btn-primary">Hasil</a></center>
                         <br>  
